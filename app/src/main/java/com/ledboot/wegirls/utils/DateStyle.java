...
public enum DateStyle {
	...
	YYYY_MM_POINT("yyyy.MM", false), YYYY_MM_DD_POINT("yyyy.MM.dd", false), YYYY_MM_DD_HH_MM_POINT(
					"yyyy.MM.dd HH:mm", false), YYYY_MM_DD_HH_MM_SS_POINT(
					"yyyy.MM.dd HH:mm:ss", false),

	YYYMMddHHmmss("yyyyMMddHHmmss",false),
